<template>
	<div >
		...
		<el-button type="success"  plain @click="add">添加管理员</el-button>
		<el-table :data="tabledata.records" column style="margin-top: 5px;">
			...
			<el-table-column label="性别" show-overflow-tooltip prop="gender"></el-table-column>
			<el-table-column label="生日" show-overflow-tooltip prop="birthday"></el-table-column>
			<el-table-column label="电话" show-overflow-tooltip prop="phone"></el-table-column>
			<el-table-column label="邮箱" show-overflow-tooltip prop="email"></el-table-column>
